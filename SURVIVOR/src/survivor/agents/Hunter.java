...
public class Hunter extends Gatherer {
	...
	protected void setup(){
		...
		this.type = Person.HUNTER;
		
		System.out.println("Hunter world is " + this.world);
		...
		addBehaviour(new HunterBehaviour(this));
		
	}
	
	static class HunterBehaviour extends CyclicBehaviour {

		private static final long serialVersionUID = 1L;
		
		public HunterBehaviour(Agent a) {
		    super(a);
		}
			...
			if ( msg != null )
			{
				if ( msg.getContent().equals("work") )
				{
					...
					{						
						...
						agent.setResourceToGather(Food.class, agent.currentPos, (agent.getEnergy()/SurvivorProperties.TRAVEL_COST - 20)/2);
